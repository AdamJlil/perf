  ...
  <div class="w-full relative" style="font-family: Montserrat">
    ...
    <div class="md:hidden flex flex-col w-full">
      ...
      <div class="flex flex-col items-center justify-center w-full text-center text-black mt-6 mb-10">
        ...
        <nuxt-link
          v-if="link.length > 0 && !isLogoutButton"
          :to="link"
          class="tracking-normal text-nowrap text-center flex justify-center border border-black py-[10px] px-[30px] text-center text-sm w-[120px] z-9 font-medium text-black"
        >
          {{ buttonText }}
        </nuxt-link>
        <div
          v-else
          class="cursor-pointer text-nowrap text-center flex justify-center tracking-normal border border-black py-[10px] px-[30px] text-center text-sm w-[120px] z-9 font-medium text-black"
    ...
    <div class="hidden md:flex w-full relative">
      ...
      <div class="absolute bottom-[50px] left-[35px] text-left text-white">
        ...
        <nuxt-link
          v-if="link.length > 0 && !isLogoutButton"
          :to="link"
          class="uppercase border border-white text-white bg-transparent font-light tracking-[5px] rounded-md hover:bg-white hover:text-black transition-colors duration-200 flex justify-center py-[10px] px-[70px] text-center text-sm md:text-base lg:text-lg w-[150px] md:w-[200px] lg:w-[250px] z-9"
        ...
        <div
          v-else
          class="cursor-pointer text-nowrap text-center flex justify-center tracking-normal border border-[#ffffff38] py-[10px] px-[70px] text-center text-sm md:text-base lg:text-lg w-[150px] md:w-[200px] lg:w-[250px] z-9"
          style="font-weight: 300"
          @click.prevent="handleButtonClick"
        >
          {{ buttonText }}
