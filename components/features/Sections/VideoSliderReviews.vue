<template>
  <div class="w-full h-[40vh] bg-black overflow-hidden relative" style="font-family: Montserrat">
    ...
    <div class="flex h-full gap-[8px] bg-black animate-scroll">
      <div v-for="(video, i) in duplicatedVideos" :key="i" class="flex-shrink-0 h-full w-[250px] bg-black">
    ...
    <div
      class="absolute inset-0 z-20 flex flex-col lg:flex-row items-center justify-center px-4 space-y-6 lg:space-y-0 lg:space-x-6 text-center lg:text-left"
    >
      <!-- Rounded Image -->
      <div
      ...
      <div class="flex flex-col space-y-4 justify-center items-center">
        <!-- Main Text -->
        <h2
          class="text-lg md:text-xl lg:text-2xl max-w-md text-white text-center"
          style="letter-spacing: 0.1em; line-height: 1.5; font-size: 1rem"
        >
          “Before <span class="font-semibold">PERF</span>, I hated working out. Now I move my body 4 to 5 times a week.
          I’m more productive, energetic and happier!”
        </h2>
...
const originalVideos: string[] = [
  "https://player.vimeo.com/external/371433846.sd.mp4?s=231da7317aaba13d573039ba33930ba78d82ca85&profile_id=164&oauth2_token_id=57447761",
  "https://player.vimeo.com/external/434045526.sd.mp4?s=c27cf1469027afed0d1ca1d5bc3840f2acdc5a3e&profile_id=164&oauth2_token_id=57447761",
  "https://player.vimeo.com/external/403737155.sd.mp4?s=74f03405935c772a2c09f1d0ca58f99051a57ca0&profile_id=164&oauth2_token_id=57447761",
  "https://player.vimeo.com/external/394165816.sd.mp4?s=43b11cf4ef86a32bc3aa44738da2f2f19989d109&profile_id=164&oauth2_token_id=57447761",
];
