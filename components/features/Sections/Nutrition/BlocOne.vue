...
<template>
  <div
    class="bg-[#EFEFEC] dark:bg-black flex flex-col justify-center items-center w-full py-10 gap-8 md:gap-12"
  ...
  >
    ...
    <div class="flex flex-col justidy-center items-center gap-[30px]">
      ...
      <div
        v-if="showButton"
        class="tracking-normal border border-black max-md:border-black py-[10px] px-[70px] text-center text-sm md:text-base lg:text-lg z-9 cursor-pointer"
