      ...
      <div class="w-full flex justify-center items-center relative">
        ...
        <div class="w-1/2 h-full relative">
          <img
            :src="image1"
            alt="Workout Image 1"
            class="w-full h-full max-h-[510px] object-cover rounded-[40px]"
            :style="image1Style"
          />
        </div>
      ...
      <div class="flex flex-col">
        ...
        <div class="w-full flex items-center justify-center">
          <img
            :src="image1"
            alt="Workout Image 1"
            class="w-full h-full object-contain rounded-[40px]"
            :style="image1Style"
          />
        </div>
        ...
        <div class="py-8 px-5 w-full max-w-md mx-auto text-center flex flex-col">
          ...
          <p
            class="text-gray-700 text-lg md:text-xl font-medium mb-8 uppercase"
            :style="[{ color: '#545454', fontWeight: 600, padding: '10px' }, EndStyle]"
          >
            <span v-html="EndText" />
          </p>
