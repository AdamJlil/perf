...
<template>
  <div
    class="bg-[#EFEFEC] dark:bg-black w-full flex flex-col md:flex-row justify-center items-center text-center p-4 md:p-[20px] gap-6 md:gap-[5%] py-8 md:py-[7rem] lg:py-50"
  >
    <!-- First Card -->
    <div
    ...
    >
      <div class="flipper">
        ...
        >
          ...
          >
            Set your establishment apart by combining fitness and comfort, boosting satisfaction rates by over 15% with
            ergonomic, innovative amenities.
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="flipper">
        ...
        >
          <div
            ...
            style="font-weight: 400"
          >
            Ensuring an unforgettable wellness experience, provide your visitors with guided, effective workout videos
      ...
      <div class="flipper">
        ...
        >
          <div
            ...
            style="font-weight: 400"
          >
            Right to your visitors rooms , elevate their Stay, with our eco-friendly fitness equipment delivered in a
            sleek charrette.
          </div>
        </div>
      </div>
