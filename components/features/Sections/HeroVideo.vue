<template>
  ...
  >
    ...
    <!-- Main Heading -->
    <p
      class="text-white z-9 text-center text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium tracking-wide mb-[50px]"
    ...
    <div class="flex flex-col md:flex-row gap-4 md:gap-8 w-full max-w-xs md:max-w-none justify-center items-center z-9">
      <nuxt-link
        to="/auth/login"
        class="text-white border border-white py-2 px-6 md:px-10 text-center text-sm md:text-base lg:text-lg max-md:w-[140px] md:w-[200px] lg:w-[300px] z-9"
    ...
    <div class="absolute bottom-6 w-full text-center z-20 px-4">
      <p class="text-white text-xs sm:text-sm md:text-base tracking-wide font-light">YOUR COMPLETE FITNESS ECOSYSTEM</p>
    </div>
  </div>
</template>
