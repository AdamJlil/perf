...
// Mock data
const users = ref([
  { firstName: "Amjad", lastName: "Arkhis", email: "john.doe@example.com", id: "ET!-amjadArkhis1" },
  { firstName: "Saad", lastName: "Tanttaoui", email: "jane.smith@example.com", id: "ET!-SaadTanttaoui2" },
  { firstName: "Lina", lastName: "BenArfa", email: "lina.ben@example.com", id: "ET!-LinaBenArfa3" },
]);
...
<template>
  ...
  >
    <Bloc1 class="my-[150px]" :reversed="true" image="/images/coach.png" headingText="“HEY THERE👋,<br/>READY TO UPGRADE YOUR CUSTOMERS EXPERIENCE?”" />

    <!-- New Section: CRUD Users Table -->
    <section class="w-full max-w-5xl bg-[#EFEFEC] rounded-lg p-6 my-12">
      <h2 class="text-2xl font-semibold text-gray-800 mb-6 text-center">Manage Users</h2>
      <div class="overflow-x-auto">
        <table class="w-full border-collapse text-left shadow-md rounded-lg bg-[#EFEFEC]">
          ...
          <tbody>
            ...
            >
              <nuxt-link
                :to="{ path: '/establishementProgram', query: { id: user.id } }"
                class="contents"
              >
                <td class="py-4 px-4">
                  <div
                ...
                <td class="py-4 px-4">{{ user.lastName }}</td>
