  ...
  <div class="w-full pt-30 flex justify-center items-center" style="font-family: &quot;Montserrat&quot;">
    <div class="w-[60vw] relative">
      ...
      <ul>
        ...
        <li>PERF is not liable for any loss or damage resulting from unauthorized account use.</li>
      </ul>
      ...
      <ul>
        <li>Some features require payment or subscription. All fees are clearly disclosed before purchase.</li>
        <li>Payments are processed securely. You agree to provide valid payment information.</li>
        <li>Subscriptions automatically renew unless cancelled before the renewal date.</li>
        <li>No refunds are provided for unused subscription periods unless required by law.</li>
      </ul>

      <h4>6. User Conduct</h4>
      <ul>
        <li>Do not use PERF for unlawful, harmful, or abusive purposes.</li>
        <li>Do not post or share offensive, misleading, or infringing content.</li>
        <li>PERF reserves the right to suspend or terminate accounts that violate these terms.</li>
      </ul>
      ...
      <h4>11. Contact</h4>
      <p>
        For questions regarding these Terms, contact us at: <span class="text-blue-500 font-bold">contact@perf.ma</span>
      </p>
    </div>
  </div>
</template>
